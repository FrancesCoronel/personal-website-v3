...
Repository.prototype.repoContent = function() {
    return [
        '<div class="card">',
        '<a href="', this.url, '" target="_blank"><button type="button" class="btn btn-primary-outline">', this.name, '</button></a>',
        '<div class="repo-info card-text"><small class="text-muted">',
        '<span><i class="fa fa-star"></i> ', this.watchers, '</span> ',
        '<span><i class="fa fa-code-fork"></i> ', this.forks, '</span>',
        '<span><b> ', this.language, '</span></b>',
        '</small>',
