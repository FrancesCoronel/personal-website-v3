...
So equality wise - regardless of whatever statistics and numbers you look at, it’s very clear that the technology field is one of the leading growth industries in the US. Not only is the industry expected to grow by <!-- prettier-ignore -->$2.4 trillion between 2014 and 2024 but it is also expected to add nearly 700,000 jobs (Wolf and Terrell 2016). The average salaries are over double the national average (Bureau of Labor Statistics 2018). And the perks offered to even an entry-level employee are vastly better when compared to almost every other industry.
